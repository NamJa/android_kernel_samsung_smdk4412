...
displayversion=SKT_Devil2-2.0.4
version=naite_$displayversion-$TARGET-$MODE-$(date +%Y%m%d)
...
ROOTFS_PATH="$KERNEL_PATH/naite-ramdisks-skt/$TARGET-combo"
MODULES="$KERNEL_PATH/naite-ramdisks-skt/modules"
